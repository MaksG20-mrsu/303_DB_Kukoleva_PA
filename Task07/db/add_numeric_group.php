...
$stmt->execute(['666', 'Тестовая группа', $currentYear + 1]);
...
if ($group_id) {
    ...
    $stmt->execute([$group_id, 'Тестов', 'Тест', 'Тестович', 'Мужской', '2004-01-01', '666-001']);
    echo "✅ Добавлена группа '666' с одним студентом\n";
} else {
