...
// Добавляем студентов
$students = [
    [$groupIds['КБ-404'], 'Горошко', 'Сергей', 'Дмитриевич', 'Мужской', '2003-12-05', 'КБ-404-001'],
    [$groupIds['КТ-101'], 'Шварц', 'Евгений', 'Юрьевич', 'Мужской', '2003-05-15', 'КТ-101-001'],
    [$groupIds['КТ-101'], 'Путт', 'Светлана', 'Снежанновна', 'Женский', '2004-02-20', 'КТ-101-002'],
    [$groupIds['КТ-101'], 'Кирдин', 'Алексей', 'Николаевич', 'Мужской', '2003-11-10', 'КТ-101-003'],
    [$groupIds['ПИ-303'], 'Николаева', 'Ольга', 'Викторовна', 'Женский', '2004-07-12', 'ПИ-303-001'],
    [$groupIds['ПИ-303'], 'Козловоский', 'Данила', 'Валерьевич', 'Мужской', '2004-03-18', 'ПИ-303-002'],
    [$groupIds['ИВ-202'], 'Смирнов', 'Алексей', 'Владимирович', 'Мужской', '2002-09-25', 'ИВ-202-001'], // Архивный студент
    [$groupIds['БИ-505'], 'Волкова', 'Софья', 'Михайловна', 'Женский', '2005-01-30', 'БИ-505-001']
];
